...
versions() {
  ...
  CONNECT_VERSION=${CONNECT_VERSION:-2.3.0}
  CERT_MANAGER_VERSION=${CERT_MANAGER_VERSION:-v1.19.3}
  EXTERNAL_DNS_VERSION=${EXTERNAL_DNS_VERSION:-1.20.0}
  ROOK_CEPH_VERSION=${ROOK_CEPH_VERSION:-v1.19.1}
  LOCAL_PATH_VERSION=${LOCAL_PATH_VERSION:-v0.0.34}
  OPENTELEMETRY_OPERATOR_VERSION=${OPENTELEMETRY_OPERATOR_VERSION:-0.105.1}
  OPENTELEMETRY_COLLECTOR_VERSION=${OPENTELEMETRY_COLLECTOR_VERSION:-0.145.0}
